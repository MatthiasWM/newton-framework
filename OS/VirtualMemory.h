...
extern "C" NewtonErr LockHeapRange(VAddr start, VAddr end, bool wire = false);	// Lock range from start up to but not including end.  Wire will prevent v->p mappings from changing.
