...
void      CFlash::suspendErase(ULong, ULong, ULong) {
  assert(0);
}

void      CFlash::resumeErase(ULong) {
  assert(0);
}

void      CFlash::deepSleep(ULong) {
  assert(0);
}

void      CFlash::wakeup(ULong) {
  assert(0);
}

NewtonErr  CFlash::status(ULong) {
  assert(0);
  return kNSErrInternalError;
}

void      CFlash::resetCard(void) {
  assert(0);
}
...
void      CFlash::registerClientInfo(ULong) {
  assert(0);
}

void      CFlash::getWriteProtected(bool * outWP) {
  assert(0);
}

void      CFlash::getWriteErrorAddress(void) {
  assert(0);
}
...
ULong      CFlash::getBlocksPerPartition(void) {
  assert(0);
  return 0;
}

ULong      CFlash::getMaxConcurrentVppOps(void) {
  assert(0);
  return 0;
}

ULong      CFlash::getEraseRegionCurrent(void) {
  assert(0);
  return 0;
}

ULong      CFlash::getWriteRegionCurrent(void) {
  assert(0);
  return 0;
}

ULong      CFlash::getEraseRegionTime(void) {
  assert(0);
  return 0;
}

ULong      CFlash::getWriteAccessTime(void) {
  assert(0);
  return 0;
}

ULong      CFlash::getReadAccessTime(void) {
  assert(0);
  return 0;
}
