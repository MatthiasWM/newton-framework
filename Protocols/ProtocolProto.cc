...
const CClassInfo *  CClassInfoRegistry::satisfy(const char * intf, const char * impl, const char * capability, const char * capabilityValue) const {
  assert(0);
  return nullptr;
}

const CClassInfo *  CClassInfoRegistry::satisfy(const char * intf, const char * impl, const int capability, const int capabilityValue) const {
  assert(0);
  return nullptr;
}
